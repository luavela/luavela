...
|PROJECT| 0.20 Lua API Reference
=================================
...
Returns ``true`` if |PROJECT|-level profiler was successful terminated, and ``false`` otherwise. Profiler cannot be used after termination.
