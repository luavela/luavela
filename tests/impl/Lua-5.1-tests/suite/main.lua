...
-- UJIT: The test below is not the part of the original suite. But as the
-- problem with the two tests above seems to be in comments, it is added here
-- for better coverage:
