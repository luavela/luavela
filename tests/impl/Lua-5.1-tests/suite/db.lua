...
function f(a,b)
  ...
  assert(x == a and y == b)
  -- UJIT: implicit arg symbol for vararg functions, same as {...}
...
-- UJIT: correct original assertion as "print" function is called right now:)
assert(a[f] and a[g] and a[assert] and a[debug.getlocal])
...
-- UJIT: getfenv/debug.getinfo for tail calls
-- h(true)
